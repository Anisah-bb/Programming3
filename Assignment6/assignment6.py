...
usage
assignment6.py -f /data/dataprocessing/interproscan/all_bacilli.tsv
'''
import warnings
...
argparser.add_argument("--IN_FILE_PATH", "-f", action="store",  type = str,
...
MODELDATA_PATH = '/homes/fabadmus/programming_3/Programming3/Assignment6/model_data'
...
REPORT_PATH = '/homes/fabadmus/programming_3/Programming3/Assignment6/model_report'
MODEL_PATH = '/homes/fabadmus/programming_3/Programming3/Assignment6/randomforest_model.sav'
